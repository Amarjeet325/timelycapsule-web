...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[500px] bg-white rounded-[24px] border border-blue-200 shadow-lg overflow-hidden mt-16 sm:mt-24 mx-4 sm:mx-8 px-4 sm:px-8 py-8 sm:py-12 flex flex-col md:flex-row items-center justify-between gap-12">
      {/* Left Content */}
